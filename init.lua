...
-- Close window
vim.keymap.set('n', '<leader>C', '<C-w>q', { desc = '[C]lose window' })

-- Tabs
vim.keymap.set('n', ']b', ':tabnext<cr>', { desc = 'next tab' })
vim.keymap.set('n', '[b', ':tabprevious<cr>', { desc = 'previous tab' })
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        ['<leader>go'] = { name = '[G]it [O]pen', _ = 'which_key_ignore' },
      }
    end,
  },
